...
class Widget_Cadastro(QtGui.QWidget):
    ...
    def ConfirmaSenha(self):
        self.setupUi()
        self.nome = self.input_nome
        self.data = self.input_nasci
        self.usuario = self.input_newuser
        self.novasenha = self.input_newpw
        self.confnovasenha = self.input_newpw_conf
        print(self.novasenha)
        print(self.confnovasenha)
        print(self.nome)
        print(self.usuario)
        print(self.data)
